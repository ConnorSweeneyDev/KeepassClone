...
public:
  ...
  // passport - lists native functions and properties exposed to script under 'frame' interface
  // name:
...
int uimain(std::function<int()> run)
{
  ...
  // note: this:://app URL is dedicated to the sciter::archive content associated with the
  // application
